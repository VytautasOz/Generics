...
public class Main {
    public static void main(String[] args) {
        ...
        ListOfNumbers result1 = MaxAverage.findWithMaxAverge(listObject1, listObject2, listObject3);
        ListOfNumbers result2 = MaxAverage.findWithMaxAverge(listObject1, listObject2);
